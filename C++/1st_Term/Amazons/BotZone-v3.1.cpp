...
bool compareScoredMoves(const ScoredMove& a, const ScoredMove& b);// 函数9：结合辅助结构体的排序函数
void newGame();// 函数10：新游戏，初始化棋盘状态

// 函数1：bot-单轮对局
void singleTurnBot(){
    if (gameRound >= 20) SEARCH_DEPTH = 4;
